...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerN5efHSd\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerN5efHSd/EntityManagerGhost614a58f.php';
require __DIR__.'/ContainerN5efHSd/RequestPayloadValueResolverGhost01ca9cc.php';
require __DIR__.'/ContainerN5efHSd/getValidator_WhenService.php';
require __DIR__.'/ContainerN5efHSd/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerN5efHSd/getValidator_NoSuspiciousCharactersService.php';
require __DIR__.'/ContainerN5efHSd/getValidator_ExpressionLanguageService.php';
require __DIR__.'/ContainerN5efHSd/getValidator_ExpressionService.php';
require __DIR__.'/ContainerN5efHSd/getValidator_EmailService.php';
require __DIR__.'/ContainerN5efHSd/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerN5efHSd/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerN5efHSd/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerN5efHSd/getTwigService.php';
require __DIR__.'/ContainerN5efHSd/getSession_Handler_NativeService.php';
require __DIR__.'/ContainerN5efHSd/getSession_FactoryService.php';
require __DIR__.'/ContainerN5efHSd/getServicesResetterService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_RouteLoader_LogoutService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerN5efHSd/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerN5efHSd/getSecrets_VaultService.php';
require __DIR__.'/ContainerN5efHSd/getSecrets_EnvVarLoaderService.php';
require __DIR__.'/ContainerN5efHSd/getRouting_LoaderService.php';
require __DIR__.'/ContainerN5efHSd/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerN5efHSd/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerN5efHSd/getErrorControllerService.php';
require __DIR__.'/ContainerN5efHSd/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerN5efHSd/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerN5efHSd/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerN5efHSd/getDoctrine_Orm_Listeners_PdoSessionHandlerSchemaListenerService.php';
require __DIR__.'/ContainerN5efHSd/getDoctrine_Orm_Listeners_LockStoreSchemaListenerService.php';
require __DIR__.'/ContainerN5efHSd/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaListenerService.php';
require __DIR__.'/ContainerN5efHSd/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaListenerService.php';
require __DIR__.'/ContainerN5efHSd/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerN5efHSd/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerN5efHSd/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerN5efHSd/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerN5efHSd/getDebug_ErrorHandlerConfiguratorService.php';
require __DIR__.'/ContainerN5efHSd/getController_TemplateAttributeListenerService.php';
require __DIR__.'/ContainerN5efHSd/getContainer_GetenvService.php';
require __DIR__.'/ContainerN5efHSd/getContainer_GetRoutingConditionServiceService.php';
require __DIR__.'/ContainerN5efHSd/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerN5efHSd/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerN5efHSd/getCache_ValidatorExpressionLanguageService.php';
require __DIR__.'/ContainerN5efHSd/getCache_SystemClearerService.php';
require __DIR__.'/ContainerN5efHSd/getCache_SystemService.php';
require __DIR__.'/ContainerN5efHSd/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerN5efHSd/getCache_AppClearerService.php';
require __DIR__.'/ContainerN5efHSd/getCache_AppService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Validator_State_ErrorProviderService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_SwaggerUi_ProcessorService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_SwaggerUi_ContextService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_SwaggerUi_ActionService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_StateProvider_ObjectService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_StateProvider_Documentation_ContentNegotiationService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_StateProvider_CreateService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_StateProcessor_LocatorService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_StateProcessor_Documentation_WriteService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_State_ErrorProviderService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Serializer_FilterParameterProviderService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Openapi_ProviderService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Metadata_PropertySchema_CollectionRestrictionService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Listener_View_WriteService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Listener_View_ValidateService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Listener_View_SerializeService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Listener_View_RespondService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_HttpCache_Processor_AddHeadersService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Doctrine_Orm_State_RemoveProcessorService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Doctrine_Orm_State_PersistProcessorService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Doctrine_Orm_State_ItemProviderService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Doctrine_Orm_State_CollectionProviderService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Doctrine_Orm_LinksHandlerService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Doctrine_Orm_Extension_ParameterExtensionService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Action_PlaceholderService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Action_NotExposedService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Action_ExceptionService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/ContainerN5efHSd/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/ContainerN5efHSd/getTemplateControllerService.php';
require __DIR__.'/ContainerN5efHSd/getRedirectControllerService.php';
require __DIR__.'/ContainerN5efHSd/getUserRepositoryService.php';
require __DIR__.'/ContainerN5efHSd/getNutritionRepositoryService.php';
require __DIR__.'/ContainerN5efHSd/getItemRepositoryService.php';
require __DIR__.'/ContainerN5efHSd/getFoodRepositoryService.php';
require __DIR__.'/ContainerN5efHSd/getCartRepositoryService.php';
require __DIR__.'/ContainerN5efHSd/getUserControllerService.php';
require __DIR__.'/ContainerN5efHSd/getFoodControllerService.php';
require __DIR__.'/ContainerN5efHSd/get_ServiceLocator_TqiKuzzService.php';
require __DIR__.'/ContainerN5efHSd/getUserControllerauthenticateUserService.php';
require __DIR__.'/ContainerN5efHSd/get_ServiceLocator_QaaoWjxService.php';
require __DIR__.'/ContainerN5efHSd/get_ServiceLocator_EWmwL0mService.php';
require __DIR__.'/ContainerN5efHSd/get_ServiceLocator_4wc4Ag1_KernelregisterContainerConfigurationService.php';
require __DIR__.'/ContainerN5efHSd/get_ServiceLocator_4wc4Ag1_KernelloadRoutesService.php';
require __DIR__.'/ContainerN5efHSd/get_ServiceLocator_4wc4Ag1Service.php';
require __DIR__.'/ContainerN5efHSd/get_Security_RequestMatcher_GOpgIHxService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_Security_UserValueResolverService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_Security_SecurityTokenValueResolverService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_Doctrine_Orm_EntityValueResolverService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_ArgumentResolver_RequestPayloadService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_ArgumentResolver_QueryParameterValueResolverService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_ArgumentResolver_DatetimeService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_ArgumentResolver_BackedEnumResolverService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_ValueResolver_ApiPlatform_ArgumentResolver_PayloadService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerN5efHSd/get_Debug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
...
$classes[] = 'App\Repository\NutritionRepository';
