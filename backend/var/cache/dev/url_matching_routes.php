...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/api/foods' => [[['_route' => 'app_foods', '_controller' => 'App\\Controller\\FoodController::getFoods'], null, ['GET' => 0], null, false, false, null]],
        '/api/user' => [[['_route' => 'add_user', '_controller' => 'App\\Controller\\UserController::addUser'], null, ['POST' => 0], null, false, false, null]],
        '/api/authenticate' => [[['_route' => 'authenticate_user', '_controller' => 'App\\Controller\\UserController::authenticateUser'], null, ['POST' => 0], null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/api(?'
    ...
    [ // $dynamicRoutes
        ...
        270 => [[['_route' => 'app_food', '_controller' => 'App\\Controller\\FoodController::getFood'], ['id'], ['GET' => 0], null, false, true, null]],
        308 => [
